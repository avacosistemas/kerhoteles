<?php include("header.php");?>
        ...
        <div class="hidden-xs" style="position:relative;">
	        <img src="img/KER_Boton_Tax_free.jpg" class="tax" style="position:absolute; bottom:0; right:0; width:8%; z-index:9999;">
        ...
        <div class="habitaciones">
	        ...
	        <div class="blanco"><!--  -->
		        <div class="col-md-6">
			        <h1>Classic</h1>
			        <p>Confortables habitaciones de 29 m² con vista al Casco Histórico de la Ciudad.</p>
	        ...
	        <div class="blanco"><!--  -->
		        <div class="col-md-6">
			        <h1>Executive</h1>
			        <p>Amplias habitaciones de 33 m² con vista 
a Puerto Madero.
...
También un sofá para mayor comodidad.</p>
			        <a href="habitaciones_deluxe.php" target="_blank">RESERV&Aacute;</a>
		        </div>
	        <div class="col-md-6 nopad">
			        <div class="carousel1">
