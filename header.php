...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
	...
	<!-- Global site tag (gtag.js) - Google Analytics -->
		...
		<script>
				...
				})(window,document,'script','dataLayer','GTM-P3B9K7X');
		</script>
    ...
    <body>
		...
		<noscript>
			<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P3B9K7X" height="0" width="0" style="display:none;visibility:hidden"></iframe>
		</noscript>
