...
jQuery(document).ready(function(){
	jQuery("#main-booking-form form.search-form").submit(function(event) {
		...
		var idioma = 'ES';
		var BookingURL = 'https://kerhoteles.mbooking.com.ar/es/reservas/';
		if(slocation == '/en/'){
			idioma = 'EN';
			BookingURL = 'https://kerhoteles.mbooking.com.ar/en/book/';
		}else if(slocation == '/pt/'){
			idioma = 'PT';
			BookingURL = 'https://kerhoteles.mbooking.com.ar/pt/reserva/';
		}
		...
		window.open(BookingURL+"?fechain="+CIN+"&fechaout="+COUT+"&hoteldestino=1.1");
    });
