...
<?php $i=0; do{ $i++;?>            
		        <div class="col-md-4">
			        <img src="https://kerrecoleta.com.ar/img_promociones/<?php echo $row_promociones['foto']; ?>" class="img-responsive" />
			        <?php if($row_promociones['link']!=''){?>
			        <a href="<?php echo $row_promociones['link']; ?>" target="_blank">VER M&Aacute;S</a>
			        <?php } else {?>
			        <a href="https://kerrecoleta.com.ar/promociones_detalle.php?id=<?php echo $row_promociones['Id']; ?>">VER M&Aacute;S</a>
			        <?php } ?>
		        </div>
