    ...
    jQuery("#main-booking-form form.search-form").submit(function(event) {
        ...
        function checkMaintenanceDays() {
            ...
            var checkTo = new Date(c2[2], parseInt(c2[1]) - 1, c2[0]);
             ...
             var popup = '<div id="maintenance-popup" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 999999; background: rgba(0,0,0,.9); text-align: center; display: none; justify-content: center; align-items: center; flex-direction: column;"><img style="width:100%; max-width: 800px; margin-bottom: 15px;" src="//recoleta.kerhoteles.com.ar/img/KER_ARMONIA_SPA_AVISO.jpg"/><a href="#" style="width: 200px; height: 40px; background: #21352a; color: #fff; text-transform: uppercase; line-height: 40px; text-decoration: none;">Entendido</a></div>'   
